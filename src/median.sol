...
contract MedianETHGSU is Median {
    bytes32 public constant wat = "ETHGSU";
...
contract MedianUSDTGSU is Median {
    bytes32 public constant wat = "USDTGSU";
...
contract MedianWBTCGSU is Median {
    bytes32 public constant wat = "WBTCGSU";
